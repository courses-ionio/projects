...
Στην τελική αναφορά  θα πρέπει να υπάρχουν τα link με τον κώδικα του παιχνιδιού. 

## Bonus
Το τρία καλύτερα παιχνίδια  θα κερδίσουν επιπλέον bonus ως εξής:
- Το καλύτερο 2 βαθμούς bonus.
- To δεύτερο καλύτερο 1 βαθμό bonus.
- To τρίτο καλύτερο 0.5 βαθμούς bonus
