...
## 2. Μπόνους ένας βαθμός, HCI, SW $

Σε κάθε μάθημα που έχει διαφάνειες-θεωρία θα γίνεται ανάρτηση σύντομων ερωτήσεων σε πραγματικό χρόνο οι οποίες θα πρέπει να απαντηθούν σε πολύ μικρό χρονικό παράθυρο (2-3 λεπτά). Για την έγκυρη καταγραφή του βαθμού, η είσοδος στην εφαρμογή γίνεται με το ionio.gr email.
