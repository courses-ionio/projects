...
Στα παραδοτέα υπάρχουν **δύο κατηγορίες** με ζητούμενα:
1. Εκείνα τα οποία θα πρέπει να υλοποιηθούν στο αποθετήριο της άσκησης το οποίο έχετε αντιγράψει (fork) **στον λογαριασμό σας**.
2. Εκείνα τα οποία θα πρέπει προωθηθούν (pull request) στο (κοινό) **αποθετήριο της άσκησης**.
