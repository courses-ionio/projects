...
Για την βαθμολόγηση, θα πρέπει να προσθέσετε στο αρχείο της αναφοράς σας για κάθε παραδοτέο ένα λινκ στον λογαριασμό σας σε ένα κοινωνικό μέσο καθώς και ένα λινκ στο αντίγραφο σας για το αποθετηρίο του βιβλίου, ώστε αν αξιολογηθούν οι αλλαγές και η προσθήκη πολυμεσικού περιεχομένου.
