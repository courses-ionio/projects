...
* Αν η εφαρμογή αξιοποιήσει περαιτέρω τεχνολογικές δυνατότητες και καινοτομίες, θα υπάρχει και η αντίστοιχη προσαύξηση στη βαθμολογία (αντικατάσταση με χάρτη της σφαίρας που περιστρέφεται ~**βαθμός: 9**, αξιοποίηση βάσης δεδομένων ~**βαθμός 10**).
