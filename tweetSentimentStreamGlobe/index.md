...
Για την υποβολή του **bonus**, θα πρέπει να γίνει ξεχωριστό **pull request** στο αποθετήριο του κώδικα, με τις αλλαγές να περιορίζονται **αποκλειστικά** στο αρχείο **AFINN-translateToGreek165.txt**.
