...
* Στην εφαρμογή υπάρχουν διαβαθμίσεις στα χρώματα των ακτίνων που εκπέμπονται ανάλογα με την ένταση του συναισθήματος (**+1 μονάδα**), διαβαθμίσεις στα χρώματα που συνοδεύουν το κάθε tweet στην αριστερή στήλη της εφαρμογής (**+0.5 μονάδες**) και διαβαθμίσεις στο χρώμα που παίρνει κάθε φορά ο αριθμός του συνολικού συναισθήματος (στην κορυφή της δεξις στήλης) (**+0.5 μονάδες**).
