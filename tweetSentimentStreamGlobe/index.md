...
### Παραδοτέο 3
* Το link στο αρχείο (ή στα αρχεία) του αποθετηρίου σας με τον κώδικα που ορίζει τις διαβαθμίσεις στα χρώματα που συνοδεύουν τα tweets στην αριστερή στήλη της εφαρμογής και τις διαβαθμίσεις στα χρώματα που παίρνει κάθε φορά ο αριθμός του συνολικού συναισθήματος (στην κορυφή της δεξιάς στήλης).
