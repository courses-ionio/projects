...
* Αλλαγή της υφής (texture) της υδρογείου (**+1 μονάδα**).
* Μείωση της ταχύτητας περιστροφής της υδρογείου (**+1 μονάδα**).
* Αν η εφαρμογή αξιοποιήσει περαιτέρω τεχνολογικές δυνατότητες και καινοτομίες, θα υπάρχει και η αντίστοιχη προσαύξηση στη βαθμολογία: Αντικατάσταση με χάρτη (2Δ) της υδρογείου ~**βαθμός: 9**. Αξιοποίηση βάσης δεδομένων ~**βαθμός 10**.
