...
Οι υπόλοιπες αλλαγές (χρώματα, οπτικοποίηση της υδρογείου κλπ) θα πρέπει να γίνουν σε ξεχωριστά branch η κάθε μία. Να σας θυμίσω ότι σε αυτήν την περίπτωση, θα πρέπει στο Heroku να δηλώσετε το κατάλληλο branch που κάνετε deploy για να δείτε το αποτέλεσμα online.
