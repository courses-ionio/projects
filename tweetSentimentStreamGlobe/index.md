...
**Συμβουλή**: Αρχικά, μπορείτε να δημιουργήσετε 4+1 **branches** του αποθετηρίου με τον κώδικα της εφαρμογής στον λογαριασμό σας και στη συνέχεια να επεξεργάζεστε τον κώδικα για το κάθε παραδοτέο στο ξεχωριστό **branch**.
