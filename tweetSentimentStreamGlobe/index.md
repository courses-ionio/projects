...
## Εκφώνηση
Στόχος αυτής της εργασίας είναι να γνωρίσετε τρόπους με τους οποίους μπορείτε να να εξάγετε και να οπτικοποιήσετε πληροφορίες που απορρέουν από τα Μέσα Κοινωνικής Δικτύωσης (π.χ. το twitter). Στο συγκεκριμένο [παράδειγμα](https://stark-lake-93710.herokuapp.com/), τα συναισθήματα που αποτυπώνονται σε κάθε tweet ανά την υδρόγειο (στην αγγλική γλώσσα), αναπαριστώνται με σε ακτίνες διαφορετικού χρώματος.
