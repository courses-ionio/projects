...
Το εκάστοτε παραδοτέο τοποθετείται στο αρχείο **Readme.md** που έχετε δημιουργήσει εντός του φακέλου σας (π.χ. στον **Ρ2016000**). Υπενθυμίζουμε ότι ο συγκεκριμένος φάκελος θα πρέπει να είναι στο κλαδί (branch) που φτιάξατε στο αποθετήριο (repository) του μαθήματος και στη συνέχεια να κάνετε τη διαδικασία **pull request** (ένα **pull request** για κάθε **παραδοτέο**).
