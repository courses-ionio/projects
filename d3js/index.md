...
- [ ] Ορισμένοι από τους αναγνώστες της εφαρμογής ενδεχομένως να είναι άτομα με περιορισμένη όραση. Τροποποιήστε τον κώδικα της εφαρμογής έτσι ώστε το ποντίκι να λειτουργεί και ως **μεγενθυντικός φακός** όταν μεταφέρεται επάνω από συγκεκριμένες περιοχές (π.χ. κείμενα). 
