...
Ο σκοπός αυτής της εργασίας είναι να προσφερεί μια απλή πρακτική εφαρμογή της θεωρίας του βιβλίου "Ο Προγραμματισμός της Διάδρασης", για τον σκοπό θα προσπαθήσουμε να πετύχουμε τους παρακάτω στόχους: 
