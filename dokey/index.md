...
* Ο βαθμός βελτιώνεται (6) για κάθε πρόσθετη λειτουργία που κάνετε και γίνεται πολύ καλός (7) αν κάνετε τα ζητούμενα με κάποιο άλλο εργαλείο, και άριστος (8-9) αν κάνετε σημαντικές διασυνδέσεις με άλλα εργαλεία του συστήματος (π.χ., [pipelining](https://youtu.be/tc4ROCJYbm0?t=296), shell scripting).
