...
## Δημιουργία ομάδων
* Για τις ομαδικές εργασίες, θα πρέπει να δημιουργήσετε ομάδες των 10 ατόμων.
* Για τη διευκόλυνσή σας, μπείτε στο αντόστοιχο discussion του μαθήματος (π.χ. για το SW: [δημιουργία ομάδων](https://github.com/courses-ionio/sw/discussions/1031)) και ακολουθήστε τις οδηγίες που θα βρείτε εκεί.
* Τα στοιχεία των μελών της κάθε ομάδας (ονοματεπώνυμο, Α.Μ., github profile link) θα πρέπει να φαίνονται στα παραδοτέα σας.
