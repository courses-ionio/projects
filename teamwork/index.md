...
* Για την βαθμολογία με την βάση (5, πέντε) αρκεί να υπάρχει εποικοδομητική συμμετοχή στις συζητήσεις, για πολύ καλή βαθμολογία απαιτείται σημαντική, έγκαιρη, και συχνή συμμετοχή, ενώ για την άριστη βαθμολόγηση θα πρέπει να γίνει [αξιολόγηση των αιτημάτων ενσωμάτωσης της τελικής αναφοράς](https://docs.github.com/en/github/collaborating-with-pull-requests/reviewing-changes-in-pull-requests/about-pull-request-reviews).
