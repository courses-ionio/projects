...
## Για τις ομαδικές εργασίες: Gitter
* Αξιοποιήστε το [Gitter](https://gitter.im/), το οποίο μπορείτε να συνδέσετε με οργανισμούς/αποθετήριά σας στο github. Φτιάξτε όσα κανάλια κρίνετε απαραίτητο και βάλτε μέλη της συνομιλίας την ομάδα σας και **αποκλειστικά** ως παρατηρητές τους @diogenisal @mkamgit και @epidrome
