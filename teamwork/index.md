...
* Αξιοποιήστε το [Gitter](https://gitter.im/), το οποίο μπορείτε να συνδέσετε με οργανισμούς/αποθετήριά σας στο github. Φτιάξτε όσα κανάλια κρίνετε απαραίτητο, προσθέστε τα μέλη της ομάδας σας, καθώς και **αποκλειστικά** ως παρατηρητές τους @diogenisal @mkamgit και @epidrome
