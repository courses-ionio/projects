...
* Οι εργασίες της επαναληπτικής εξεταστικής παραδίδονται με προθεσμία την ημέρα της γραπτής εξέτασης.
...
* Η γραπτή εξέταση γίνεται με κλειστά βιβλία και σημειώσεις
