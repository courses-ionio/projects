...
* Unreal Engine, Unity
* GitHub project: [Κατασκευή ιστοσελίδας για το τμήμα Πληροφορικής](sitedi/), [Twitter Sentiment Analysis](https://github.com/courses-ionio/sw/tree/master/projects_2017/tweetSentimentStreamGlobe), [Phaser HTML5 Games](PhaserGames/readme.md)
