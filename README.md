...
Η εργασία είναι ατομική. Ομαδικές εργασίες δίνονται μόνο σε ειδικές περιπτώσεις, όπου θα πρέπει να φέρετε αναλυτικό πλάνο με τον καταμερισμό της εργασίας που απαιτεί δύο ή περισσότερα άτομα, π.χ. ανάπτυξη client-server. Πέρα από τα παρακάτω ενδεικτικά θέματα, εάν έχετε δεξιότητα σε κάποιο άλλο περιβάλλον και γλώσσα προγραμματισμού τότε μπορείτε να διαλέξετε άλλο θέμα με βάση τα ενδιαφέροντα σας και μόνο σε συμφωνία με τον διδάσκοντα ή/και τους βοηθούς. 
