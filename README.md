...
* Unreal Engine, Unity
* GitHub project: [Κατασκευή ιστοσελίδας για το τμήμα Πληροφορικής](sitedi/), [Twitter Sentiment Analysis](https://github.com/courses-ionio/projects/tree/master/tweetSentimentStreamGlobe), [Phaser HTML5 Games](PhaserGames/readme.md)
